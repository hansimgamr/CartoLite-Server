...
export default defineConfig({
  ...
  projects: [
    {
      name: 'desktop',
      testIgnore: [/tablet-portrait\.spec\.ts/, /area-(controls|traffic)\.spec\.ts/],
      use: { ...devices['Desktop Chrome'], viewport: { width: 1440, height: 900 } }
    },
    { name: 'mobile', testIgnore: [/tablet-portrait\.spec\.ts/, /area-(controls|traffic)\.spec\.ts/], use: { ...devices['Pixel 7'] } },
    {
